...
interface RandomFunction extends PRNG {
	/**
	* Returns an ndarray containing pseudorandom numbers drawn from a geometric distribution.
	*
	...
	*/
	...
	/**
	* Fills an ndarray with pseudorandom numbers drawn from a geometric distribution.
	*
	* @param p - success probability
...
interface Random extends PRNG {
	...
	*/
	...
	/**
	* Returns a function for creating ndarrays containing pseudorandom numbers drawn from a geometric distribution.
	*
	* @param options - function options
