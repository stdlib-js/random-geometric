...
{
	random( [ 3, 3 ], 0.01 ); // $ExpectType RandomArray
	random( [ 3, 3 ], 0.01, {} ); // $ExpectType RandomArray
}
...
{
	random( [ 3, 3 ], 0.01, '5' ); // $ExpectError
	random( [ 3, 3 ], 0.01, 5 ); // $ExpectError
	random( [ 3, 3 ], 0.01, true ); // $ExpectError
	random( [ 3, 3 ], 0.01, false ); // $ExpectError
	random( [ 3, 3 ], 0.01, [] ); // $ExpectError
	random( [ 3, 3 ], 0.01, ( x: number ): number => x ); // $ExpectError
}

// The compiler throws an error if the function is provided a `dtype` option which is not a supported data type...
{
	random( [ 3, 3 ], 0.01, { 'dtype': 123 } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'dtype': 'abc' } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'dtype': null } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'dtype': [] } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'dtype': {} } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'dtype': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function is provided an invalid `order` option...
{
	random( [ 3, 3 ], 0.01, { 'order': 123 } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'order': 'abc' } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'order': null } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'order': [] } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'order': {} } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'order': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function is provided an invalid `mode` option...
{
	random( [ 3, 3 ], 0.01, { 'mode': 123 } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'mode': 'abc' } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'mode': null } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'mode': [] } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'mode': {} } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'mode': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function is provided an invalid `submode` option...
{
	random( [ 3, 3 ], 0.01, { 'submode': 123 } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'submode': 'abc' } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'submode': null } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'submode': [ '1' ] } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'submode': {} } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'submode': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function is provided an invalid `readonly` option...
{
	random( [ 3, 3 ], 0.01, { 'readonly': 123 } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'readonly': 'abc' } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'readonly': null } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'readonly': [] } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'readonly': {} } ); // $ExpectError
	random( [ 3, 3 ], 0.01, { 'readonly': ( x: number ): number => x } ); // $ExpectError
}
...
// Attached to the main export is an `assign` method which returns an ndarray...
{
	...
	random.assign( 0.01, arr ); // $ExpectType float64ndarray
}
...
// The compiler throws an error if the `assign` method is provided a second argument which is not an ndarray...
{
	...
	random.assign( 0.01, [ '1' ] ); // $ExpectError
...
// The compiler throws an error if the `assign` method is provided an unsupported number of arguments...
{
	...
	random.assign( 0.01 ); // $ExpectError
	random.assign( 0.01, arr, {} ); // $ExpectError
}
...
// The `factory` method returns a function which returns an ndarray...
{
	...
	fcn1( [ 3, 3 ], 0.01 ); // $ExpectType RandomArray

	const fcn2 = random.factory( {} );
	fcn2( [ 3, 3 ], 0.01 ); // $ExpectType RandomArray
}
...
{
	const fcn1 = random.factory();
	fcn1( true, 0.01 ); // $ExpectError
	fcn1( false, 0.01 ); // $ExpectError
	fcn1( '5', 0.01 ); // $ExpectError
	fcn1( [ '1' ], 0.01 ); // $ExpectError
	fcn1( {}, 0.01 ); // $ExpectError
	fcn1( ( x: number ): number => x, 0.01 ); // $ExpectError
...
// The compiler throws an error if the function returned by the `factory` method is provided a `dtype` option which is not a supported data type...
{
	...
	fcn( [ 3, 3 ], 0.01, { 'dtype': 123 } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'dtype': 'abc' } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'dtype': null } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'dtype': [] } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'dtype': {} } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'dtype': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function returned by the `factory` method is provided an invalid `order` option...
{
	const fcn = random.factory();
	fcn( [ 3, 3 ], 0.01, { 'order': 123 } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'order': 'abc' } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'order': null } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'order': [] } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'order': {} } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'order': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function returned by the `factory` method is provided an invalid `mode` option...
{
	const fcn = random.factory();
	fcn( [ 3, 3 ], 0.01, { 'mode': 123 } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'mode': 'abc' } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'mode': null } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'mode': [] } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'mode': {} } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'mode': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function returned by the `factory` method is provided an invalid `submode` option...
{
	const fcn = random.factory();
	fcn( [ 3, 3 ], 0.01, { 'submode': 123 } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'submode': 'abc' } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'submode': null } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'submode': [ '1' ] } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'submode': {} } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'submode': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function returned by the `factory` method is provided an invalid `readonly` option...
{
	const fcn = random.factory();
	fcn( [ 3, 3 ], 0.01, { 'readonly': 123 } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'readonly': 'abc' } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'readonly': null } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'readonly': [] } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'readonly': {} } ); // $ExpectError
	fcn( [ 3, 3 ], 0.01, { 'readonly': ( x: number ): number => x } ); // $ExpectError
}
